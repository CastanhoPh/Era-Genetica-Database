...
export const PENDING_CHARACTERS: { village: string; entries: { name: string; role?: string; dead?: boolean; nc?: number; era?: string }[] }[] = [
  {
    ...
    entries: [
      ...
      { name: 'Hinode Hyuga', role: 'Esposa de Masahiro Hyuga, mãe de Ryuta e Renji' },
      { name: 'Setsuna Yamanaka', role: 'Esposa de Tajima Uchiha, mãe de Madara, Izuna e Reizan' },
      { name: 'Tsubasa Uchiha', role: 'Filho de Oogway e Tomoe' },
      ...
      { name: 'Tsubaki Shimura', role: 'Esposa de Fuyuhiko Chinoike, mãe de Furyuzan e Shikure' },
    ],
  },
  {
    village: 'Kirigakure',
